...
const MovieCard = ({ movie }) => {
  ...
  return (
    <div
      ...
      className="group relative bg-white rounded-xl overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300 cursor-pointer"
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2 mt-1">
          ...
          <span className="text-sm text-gray-600">{movie.genre.join(', ')}</span>
        </div>
